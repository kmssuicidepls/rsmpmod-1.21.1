...
public class RatAnimations {
        public static final AnimationDefinition rat_idle = AnimationDefinition.Builder.withLength(1.0F)
        ...
        public static final AnimationDefinition rat_walk = AnimationDefinition.Builder.withLength(1.0F)
                ...
                .addAnimation("controller", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
                ))
